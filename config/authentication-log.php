...
return [
    ...
    'notifications' => [
        'new-device' => [
            // Admin-only audit trail — never email users about new devices.
            'enabled' => false,
        ...
        'failed-login' => [
            // Admin-only audit trail — never email users about failed logins.
            'enabled' => false,
        ...
        'suspicious-activity' => [
            // Admin-only audit trail — never email users about suspicious activity.
            'enabled' => false,
