...
@section('content')
    ...
    <main class="pt-24 pb-16">
        ...
        <section class="landing-section px-6 py-12 bg-[#fafaf8]">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-10 landing-fade-in">
                    <h2 class="landing-heading text-2xl sm:text-3xl text-[#1a1208]">
                ...
                <div class="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
                    @foreach ([
                        ...
                        <div class="landing-card rounded-2xl border border-[#1a1208]/15 bg-white p-6 landing-fade-in">
                            <div class="mb-4 flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#c9a227] bg-white text-sm font-semibold text-[#c9a227] landing-heading">
                                {{ $index + 1 }}
                            </div>
        ...
        <section class="landing-section px-6 py-12">
            <div class="max-w-3xl mx-auto landing-card rounded-2xl border border-[#1a1208]/15 bg-white p-8 text-center landing-fade-in">
