<section class="landing-section px-6 py-16 sm:py-20">
    <div class="max-w-6xl mx-auto landing-value-strip landing-fade-in">
        @foreach ([
            ['title' => __('landing.value_1_title'), 'text' => __('landing.value_1_text')],
            ['title' => __('landing.value_2_title'), 'text' => __('landing.value_2_text')],
            ['title' => __('landing.value_3_title'), 'text' => __('landing.value_3_text')],
            ['title' => __('landing.value_4_title'), 'text' => __('landing.value_4_text')],
        ] as $item)
            <div>
