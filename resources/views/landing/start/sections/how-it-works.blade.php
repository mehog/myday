    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="relative">
            ...
            <div class="grid md:grid-cols-4 gap-8 md:gap-8">
                @foreach ([
                    ['num' => '01', 'title' => __('start.step_1_title'), 'text' => __('start.step_1_text')],
                    ['num' => '02', 'title' => __('start.step_2_title'), 'text' => __('start.step_2_text')],
                    ['num' => '03', 'title' => __('start.step_3_title'), 'text' => __('start.step_3_text')],
                    ['num' => '04', 'title' => __('start.step_4_title'), 'text' => __('start.step_4_text')],
                ] as $step)
