@if (! $isPreview)
    ...
    <style>
        ...
        .gate-photo-canvas {
            ...
            container-name: gate-canvas;
            overflow: hidden;
            isolation: isolate;
            background: #060c10;
            box-shadow:
                0 24px 60px rgba(0, 0, 0, 0.28),
                0 0 0 1px rgba(140, 170, 200, 0.1);
        }

        .gate-photo-canvas::after {
            content: '';
            position: absolute;
            z-index: 8;
            inset: 0;
        ...
        .gate-photo-stage.gate-is-opening .gate-photo-canvas::after {
        ...
        .gate-photo-trigger:focus-visible .gate-photo-canvas {
        ...
        .gate-moonlight {
            ...
            height: clamp(120px, 28cqh, 240px);
            border-radius: 50%;
            opacity: 0;
            pointer-events: none;
            background: radial-gradient(
        ...
        @container gate-canvas (max-width: 381px) {
            .gate-open-copy {
                width: 88%;
            }
            ...
            .gate-latch-light {
                width: clamp(38px, 11cqw, 72px);
                height: clamp(38px, 11cqw, 72px);
            }
        }
