<div>
    ...
    <form wire:submit="nextStep" class="space-y-5">
        <div>
            ...
            <input id="location_name" type="text" wire:model="location_name" class="landing-input w-full" placeholder="{{ __('onboarding.location_name_placeholder') }}">
        ...
        <div>
            ...
            <input id="location_address" type="text" wire:model="location_address" class="landing-input w-full" placeholder="{{ __('onboarding.location_address_placeholder') }}">
