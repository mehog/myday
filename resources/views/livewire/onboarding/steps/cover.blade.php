<div>
    ...
    <form wire:submit="nextStep" class="space-y-5">
        <div>
            ...
            <input id="hero_image" type="file" wire:model="hero_image" accept="image/*" @required(! $hasPersistedCover) class="landing-input w-full text-sm">
            ...
            @if ($coverPreviewUrl)
                <div class="mt-4 rounded-xl overflow-hidden border border-[#1a1208]/10">
                    <img src="{{ $coverPreviewUrl }}" alt="" class="w-full h-48 object-cover">
                </div>
            @endif
        </div>
