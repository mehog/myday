...
return [
    ...
    'children_question' => 'Bringen Sie Kinder mit?',
    'children_name_placeholder' => 'Name des Kindes',
    'children_helper_text' => 'Optional. Geben Sie die Namen der mitkommenden Kinder an, damit wir Sitzplan und Tischkarten vorbereiten können.',
    'children_add' => 'Kind hinzufügen',
    'children_remove' => 'Kind entfernen',
    ...
    'menu_question' => 'Menü wählen',
    'menu_question_for' => 'Menü für :name',
    'menu_question_yourself' => 'Ihr Menü',
    'menu_question_plus_one' => 'Menü für Ihre Begleitung',
    'menu_question_child' => 'Menü für :name',
    'menu_placeholder' => 'Menü auswählen',
    'menu_required' => 'Bitte wählen Sie ein Menü.',
    'accommodation_question' => 'Benötigen Sie eine Unterkunft?',
    'accommodation_helper' => 'Markieren Sie dies, wenn Sie für die Hochzeit eine Unterkunft brauchen.',
    'accommodation_count_label' => 'Für wie viele Personen wird eine Unterkunft benötigt?',
    'accommodation_count_required' => 'Bitte geben Sie an, für wie viele Personen eine Unterkunft benötigt wird.',
    'accommodation_count_max' => 'Die Anzahl für die Unterkunft darf die Größe Ihrer Gruppe nicht überschreiten.',
    ...
    'share_photos_and_messages' => 'Fotos, Videos & Nachrichten teilen',
    ...
    'contact_page_description' => 'Teilen Sie eine Nachricht, eine Sprachaufnahme, Fotos oder Videos mit dem Brautpaar, :name.',
    'contact_page_qr_title' => 'Willkommen an unserem Tag!',
    'contact_page_qr_description' => 'Schön, dass Sie da sind, :name! Teilen Sie eine Nachricht, Sprachnotiz, Fotos oder Videos mit uns.',
    ...
    'send_videos' => 'Videos senden',
    'send_videos_description' => 'Teilen Sie Videoerinnerungen von der Hochzeit (bis zu 3 Videos, max. 50 MB pro Video).',
    'select_videos' => 'Videos auswählen',
    'choose_videos' => 'Videos wählen',
    'no_videos_selected' => 'Keine Videos ausgewählt',
    'videos_selected' => ':count Videos ausgewählt',
    'remove_video' => 'Video entfernen',
    'videos_available_from' => 'Video-Sharing ist ab dem Hochzeitstag (:date) und 30 Tage danach verfügbar.',
    'videos_not_available' => 'Video-Sharing ist derzeit nicht verfügbar.',
    'videos_required' => 'Bitte wählen Sie mindestens ein Video aus.',
    'videos_max' => 'Sie können bis zu 3 Videos gleichzeitig senden.',
    'uploading_videos' => 'Videos werden hochgeladen...',
    'videos_upload_error' => 'Ein oder mehrere Videos konnten nicht hochgeladen werden. Bitte versuchen Sie es erneut.',
    'videos_format_error' => 'Videoformat wird nicht unterstützt. Bitte MP4, MOV oder WebM verwenden.',
    'photos_plan_required' => 'Foto-Sharing erfordert einen bezahlten Plan. Das Brautpaar kann das im Dashboard freischalten.',
    'videos_plan_required' => 'Video-Sharing erfordert einen bezahlten Plan. Das Brautpaar kann das im Dashboard freischalten.',
