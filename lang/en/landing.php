...
return [
    ...
    'feature_invite_text' => 'Guests open a beautiful page with your names, countdown, schedule, location and gallery. Personalized links greet them by name.',
    'feature_invite_point_1' => 'Countdown to the wedding day',
    'feature_invite_point_2' => 'Day schedule and venue details',
    ...
    'feature_rsvp_text' => 'Track every guest from one list. Send personalized links, watch RSVPs update live, and keep the whole group in sync.',
    'feature_rsvp_point_1' => 'Personalized links for each guest',
    'feature_rsvp_point_2' => 'Live yes, no and pending statuses',
    'feature_rsvp_point_3' => 'Send via WhatsApp, Viber, Telegram or Messenger',
    'feature_rsvp_point_4' => 'Import guests and keep notes in one place',
    ...
    'feature_updates_text' => 'Your panel shows opens, responses and activity at a glance. Send push updates when plans change.',
    'feature_updates_point_1' => 'Visit and RSVP overview on the dashboard',
