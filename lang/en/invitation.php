...
return [
    ...
    'children_question' => 'Are you bringing children?',
    'children_name_placeholder' => 'Child’s name',
    'children_helper_text' => 'Optional. Add the names of children coming with you so we can prepare seating and place cards.',
    'children_add' => 'Add child',
    'children_remove' => 'Remove child',
    ...
    'menu_question' => 'Choose a menu',
    'menu_question_for' => 'Menu for :name',
    'menu_question_yourself' => 'Your menu',
    'menu_question_plus_one' => 'Menu for your companion',
    'menu_question_child' => 'Menu for :name',
    'menu_placeholder' => 'Select a menu',
    'menu_required' => 'Please choose a menu.',
    'accommodation_question' => 'Do you need accommodation?',
    'accommodation_helper' => 'Check this if you need accommodation for the wedding.',
    'accommodation_count_label' => 'How many people need accommodation?',
    'accommodation_count_required' => 'Please enter how many people need accommodation.',
    'accommodation_count_max' => 'Accommodation count cannot exceed your party size.',
    ...
    'share_photos_and_messages' => 'Share photos, videos & messages',
    ...
    'contact_page_description' => 'Share a message, audio recording, photos, or videos with the newlyweds, :name.',
    'contact_page_qr_title' => 'Welcome to our day!',
    'contact_page_qr_description' => 'Glad you\'re here, :name! Share a message, voice note, photos, or videos with us.',
    ...
    'photos_plan_required' => 'Photo sharing requires a paid plan. The newlyweds can unlock it from their dashboard.',
    ...
    'photos_upload_error' => 'Failed to upload one or more photos. Please try again.',
    'send_videos' => 'Send videos',
    'send_videos_description' => 'Share video memories from the wedding (up to 3 videos, max 50 MB each).',
    ...
    'videos_available_from' => 'Video sharing will be available from the wedding day (:date) and for 30 days after.',
    'videos_not_available' => 'Video sharing is not available yet.',
    'videos_plan_required' => 'Video sharing requires a paid plan. The newlyweds can unlock it from their dashboard.',
    'videos_required' => 'Please select at least one video.',
    'videos_max' => 'You can send up to 3 videos at a time.',
    'uploading_videos' => 'Uploading videos...',
    'videos_upload_error' => 'Failed to upload one or more videos. Please try again.',
    'videos_format_error' => 'Video format is not supported. Please use MP4, MOV, or WebM.',
    ...
    'token_only_preview_rsvp' => 'Each guest will see the RSVP when they open their personal invitation link. It is not shown on this public preview.',
    ...
    'demo_create_sticky_text' => 'Create your own invitation page',
    'demo_create_sticky_cta' => 'Create invitation now',
];
